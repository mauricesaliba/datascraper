...
**to get issues use jql:** 'team in( 1 , 2, 3, 4, 5, 6) AND resolved >= "2019/01/01" AND resolved <= "2021/12/31" ORDER BY key'
...
python jql_to_csv.py -u maurice.saliba -U "http://jira.go.com.mt" --jql 'team in( 1 , 2, 3, 4, 5, 6) AND resolved >= "2019/01/01" AND resolved <= "2021/12/31" ORDER BY key' -n 5000
